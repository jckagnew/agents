...
exports.trackAIAnalysis = trackAIAnalysis;
exports.trackAIError = trackAIError;
exports.trackTestRun = trackTestRun;
exports.trackGenericEvent = trackGenericEvent;
const SUPABASE_URL = process.env.FACTORY_SUPABASE_URL ||
    process.env.NEXT_PUBLIC_SUPABASE_URL ||
    process.env.SUPABASE_URL ||
    '';
const SUPABASE_KEY = process.env.FACTORY_SUPABASE_SERVICE_KEY ||
