...
HydroTrack uses **React state management** (Context API + localStorage) to handle application state. This document maps key states, transitions, and user interactions.
