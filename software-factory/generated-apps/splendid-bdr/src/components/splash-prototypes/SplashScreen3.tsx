...
const SplashScreen3: React.FC<SplashScreen3Props> = ({ onGetStarted, onLogin }) => {
  ...
  const images = [
    ...
    {
      src: "https://images.pexels.com/photos/6672086/pexels-photo-6672086.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "After transformation",
      description: "Photo by Moe Magners - Confident woman showing weight loss message painted on her stomach, symbolizi..."
    }
  ];
