...
interface SplashScreenV1Props {
  onCreateProfile: () => void;
  onLogin: () => void;
}

export const SplashScreenV1: React.FC<SplashScreenV1Props> = ({
  onCreateProfile,
  onLogin,
}) => {
