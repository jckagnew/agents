...
import { SplashScreenV1 } from '../../components/splash-prototypes/SplashScreenV1';
import { SplashScreenV2 } from '../../components/splash-prototypes/SplashScreenV2';
import { SplashScreenV3 } from '../../components/splash-prototypes/SplashScreenV3';

export default function SplashComparison() {
  const [currentVersion, setCurrentVersion] = useState(1);
  const versions = [
    { id: 1, name: 'Version 1', component: SplashScreenV1, score: 0.53 },
    { id: 2, name: 'Version 2', component: SplashScreenV2, score: 0.53 },
    { id: 3, name: 'Version 3', component: SplashScreenV3, score: 0.53 }
  ];
